...
from .paths import resolve_bible_path
...
def harmonize(
    input: str,
    style: Annotated[str, typer.Argument()] = "Generic",
    ...
    # Load bible.json: cwd override, dev project root, or bundled default
    bible_path = resolve_bible_path()
